...
# ~~~~~~~~~~~ 1) S3 ~~~~~~~~~~~
aws s3 rm s3://dtq-s3-laravel8/ --recursive
aws s3api delete-bucket --bucket dtq-s3-laravel8
...
# ~~~~~~~~~~~ 5) RDS ~~~~~~~~~~~
aws rds delete-db-instance --db-instance-identifier dtq-mysql-instance-laravel8 --skip-final-snapshot
...
## ~~~~~~~~~~~ deploy!!!
aws deploy delete-application --application-name DTQCodeDeployLaravel8 
...
# ~~~~~~~~~~~ 14) EC2 ~~~~~~~~~~~
## ~~~~~~~~~~~ list SG!!!
instance_id=$(aws ec2 describe-instances --filters "Name=tag:Name,Values=CodeDeploy" --query "Reservations[].Instances[].InstanceId" --output text)
